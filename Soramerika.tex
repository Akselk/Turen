...
\begin{figure}[H]
	\centering
	\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{doisvenstre}}
\caption*{Dois Irmaos}
...
\begin{figure}[H]
	\centering
	\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{doishoyre}}
...
\end{wrapfigure}
Jeg kom frem til et leilighetskompleks. Det var låst. Heldigvis
...
%	\centering
%	\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{doisvenstre}}
%\caption*{Rio sett fra fra Dois Irmaos. Ipanema er stranda helt til
%høyre i bildet}
%	\label{fig:doisermaos}
%\end{figure}
...
%	\centering
%	\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{doishoyre}}
%	\caption*{Alexander, lille-Alexander og meg. Pluss et par}
%	\label{fig:doishoyre}
%\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{rioute}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{patoppen}
	\caption*{På toppen!}
	\label{fig:toppen}
\end{figure}
...
\begin{figure}[H]
	\centering
\noindent\makebox[\textwidth]{\includegraphics[width=0.9\paperwidth]{peruforside}}
...
\textit{Og hun sender ham videre
...
\begin{figure}[!h]
	\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{esel}}
...
\begin{figure}[H]
	\centering
	\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{soveikoye}}
...
\begin{figure}[H]
	\centering
	\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{tayronavenstre}}
...
\begin{figure}[H]
	\centering
	\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{tayronahoyre}}
...
\textit{Oddly enough, Columbia can sometimes give you exactly what you
	would expect. 
	...
	party where we get down to some more drinking. Later on, we
...
\begin{figure}[H]
	\centering
	\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{akselogclara}}
...
\begin{figure}[H]
	\vspace{-2.5cm}
	\centering
	\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{livreddesvenstre}}
\caption*{}
	\label{fig:doise}
\end{figure}
	\thispagestyle{empty}
\begin{figure}[H]
	\vspace{-2.5cm}
	\centering
	\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{livreddeshoyre}}
	\caption*{}
	\label{fig:doishoyre}
\end{figure}
\clearpage
